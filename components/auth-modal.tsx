        ...
        <div className="p-8 sm:p-10">
          <DialogHeader className="text-center space-y-3 mb-8">
            ...
            <DialogDescription className="text-muted-foreground">
              Sign in to save your preferences and access all tools.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <Button
              variant="outline"
              className="w-full h-12 gap-3 text-base font-medium border-border/50 hover:bg-secondary/50 hover:border-border transition-all"
            >
